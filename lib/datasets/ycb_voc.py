...
class ycb_voc(imdb):
    def __init__(self, image_set, devkit_path=None):
        imdb.__init__(self, 'ycb_voc_' + image_set)
        self._year = '2007'
        self._image_set = image_set
        self._devkit_path = self._get_default_path() if devkit_path is None \
            else devkit_path
        self._data_path = os.path.join(self._devkit_path, 'ycb_voc', 'VOC2012')
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join(self._devkit_path, 'results', 'ycb_voc', 'Main')
    ...
    def _write_voc_results_file(self, all_boxes):
        for cls_ind, cls in enumerate(self.classes):
            if cls == '__background__':
                continue
            print('Writing {} ycb_voc results file'.format(cls))
